package com.prueba.inditex.infrastructure.adapters.output.customizedexception;
...
import com.prueba.inditex.infrastructure.adapters.output.customizedexception.data.response.ExceptionResponse;
...
public class CustomizedExceptionAdapter extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleAllExceptions(Exception ex, WebRequest request) {
        ExceptionResponse exceptionResponse = new ExceptionResponse( ex.getMessage(), Arrays.asList(request.getDescription(false)));
